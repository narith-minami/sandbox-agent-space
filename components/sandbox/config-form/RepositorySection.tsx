...
export function RepositorySection({ control, setValue, compact = false }: RepositorySectionProps) {
  ...
  return (
    <div className={compact ? 'space-y-4' : 'space-y-4 p-4 border rounded-lg bg-muted/30'}>
      {!compact && <h3 className='font-semibold text-sm'>Repository Information</h3>}
